...
module.exports = function (grunt) {
      ...
      dist: {
        files: [{
          ...
          src: [
            ...
            '.htaccess',
            'bower_components/**/*',
            'assets/images/{,*/}*.{png,jpg,jpeg,gif,webp,svg,PNG}',
            'assets/fonts/**/*',
  ...
  grunt.registerTask('serve', function (target) {
    if (target === 'dist') {
      return grunt.task.run(['build', 'env:all', 'env:prod', 'replace:development','express:prod', 'wait', 'open', 'express-keepalive']);
    }
  ...
  grunt.registerTask('build', function (target) {
      ...
      //update app server url to dev server
      if (target === 'staging') {
  ...
  //locally run with dev app server
  ...
  //locally run with prod app server
  grunt.registerTask('production', function (target) {
    //locally create dist with prod app server
    if (target === 'dist') {
      return grunt.task.run([
        'build',
         'env:all',
